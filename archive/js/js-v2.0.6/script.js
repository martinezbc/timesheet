...
arrayForEach(document.querySelectorAll('.fa-trash-alt'), 'click', removeOWFTLV);
...
arrayForEach(document.querySelectorAll("input[name='ftvoucher']"), 'keyup', (e) => {limitCharacters(e, 6)});
