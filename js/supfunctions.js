...
//Area selection
var radioarea = document.querySelectorAll("input[name='SupArea']");
for (i = 0; i < radioarea.length; i++) {
    radioarea[i].addEventListener("change", radioAreaSelect);
}

//Week selection
byID("supweek1").addEventListener("change", updateWeek);
byID("supweek2").addEventListener("change", updateWeek);
byID("supweek3").addEventListener("change", updateWeek);
byID("supweek4").addEventListener("change", updateWeek);
