...
for (i = 0; i < veh.length; i += 1) {
    veh[i].addEventListener("keyup", function () {
...
function loadTeamValues() {
    ...
    for (var i = 0; i < areadiv.length; i += 1) {
